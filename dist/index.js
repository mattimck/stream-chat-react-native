...
var Markdown = _interopDefault(require('react-native-simple-markdown'));
...
var styles = {
  Avatar: reactNative.StyleSheet.create({
    image: {
      width: 50,
      height: 50
    },
  ...
  MessageSimple: reactNative.StyleSheet.create({
  ...
  MessageSimpleAvatar: reactNative.StyleSheet.create({
    left: {
      marginRight: 8
    },
    right: {
  ...
  MessageSimpleContent: reactNative.StyleSheet.create({
  ...
  MessageSimpleText: reactNative.StyleSheet.create({
    container: {
  ...
  MessageInput: reactNative.StyleSheet.create({
    container: _objectSpread({}, Layouts.flexColumn, {
      borderRadius: 10,
  ...
  HyperLink: reactNative.StyleSheet.create({
    title: {
      color: Colors.primary,
      fontWeight: 'bold'
    }
  }),
  Card: reactNative.StyleSheet.create({
  ...
  AttachmentActions: reactNative.StyleSheet.create({
    container: {
      flexDirection: 'row',
      justifyContent: 'space-between',
      padding: 5
  ...
  MessageNotification: reactNative.StyleSheet.create({
    container: _objectSpread({}, Layouts.flexColumn, {
      alignItems: 'center',
      zIndex: 10,
      marginBottom: 0
  ...
  Notification: reactNative.StyleSheet.create({
    container: _objectSpread({}, Layouts.flexColumn, {
      alignItems: 'center',
      zIndex: 10,
      marginBottom: 0,
  ...
  DateSeparator: reactNative.StyleSheet.create({
    container: _objectSpread({}, Layouts.flexRow, {
      justifyContent: 'center',
      alignItems: 'center'
    }),
  ...
  ReactionPicker: reactNative.StyleSheet.create({
    container: {
      display: 'flex',
      flexDirection: 'row',
  ...
  iconBadge: reactNative.StyleSheet.create({
    icon: {
      paddingTop: 5,
      alignSelf: 'center',
      borderRadius: 20,
...
function buildStylesheet(styleName, styleOverwrites) {
  ...
  var base = Object.keys(baseStyle).map(function (k) {
    return _defineProperty({}, k, reactNative.StyleSheet.flatten(baseStyle[k]));
  ...
  var topLevelOverwrites = Object.keys(styleOverwrites).map(function (k) {
    if (depthOf(styleOverwrites[k]) === 1) {
      return _defineProperty({}, k, reactNative.StyleSheet.flatten(styleOverwrites[k]));
    }
  ...
  return reactNative.StyleSheet.create(lodashEs.defaultsDeep(topLevelOverwrites, base));
}
...
function (_React$PureComponent) {
  ...
  _createClass(Avatar, [{
    ...
    value: function render() {
      ...
      }, image && !this.state.imageError ? React__default.createElement(reactNative.Image, {
...
exports.NetInfo = function NetInfo() {
...
function (_PureComponent) {
  ...
  function Chat(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setConnectionListener", function () {
      exports.NetInfo.isConnected.fetch().then(function (isConnected) {
        _this.notifyChatClient(isConnected);
      });
      exports.NetInfo.addEventListener('connectionChange', _this.handleConnectionChange);
    });
  ...
  _createClass(Chat, [{
    ...
    value: function componentWillUnmount() {
      ...
      exports.NetInfo.removeEventListener('connectionChange', this.handleConnectionChange);
    }
  }, {
    key: "render",
    value: function render() {
  ...
  _createClass(LoadingIndicator, [{
    ...
    value: function render() {
      switch (this.props.listType) {
        case 'channel':
          return React__default.createElement(reactNative.Text, null, "Loading channel list ...");

        case 'message':
          return React__default.createElement(reactNative.Text, null, "Loading messages ...");

        case 'default':
        default:
          return React__default.createElement(reactNative.Text, null, "Loading ...");
      }
    }
  }]);
  ...
  function ChannelInner(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onLayout", function (_ref7) {
      ...
      if (!_this.initialHeight) {
        ...
        _this.setState({
          channelHeight: new reactNative.Animated.Value(_this.initialHeight)
        });
      }
    });
  ...
  _createClass(ChannelInner, [{
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 12:
                ...
                this.keyboardDidShowListener = reactNative.Keyboard.addListener('keyboardWillShow', this.keyboardDidShow);
                this.keyboardDidHideListener = reactNative.Keyboard.addListener('keyboardWillHide', this.keyboardDidHide);
    ...
    value: function render() {
      ...
      if (this.state.error) {
        ...
        core = React__default.createElement(reactNative.Animated.View, {
          style: {
            display: 'flex',
...
function (_React$Component) {
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      ...
      }, title && React__default.createElement(reactNative.Text, null, title), React__default.createElement(reactNative.Text, null, this.trimUrl(title_link || og_scrape_url))), type === 'giphy' && React__default.createElement(reactNative.Image, {
        source: img
      })));
    }
  }]);
...
var GalleryHeader = function GalleryHeader(_ref) {
  ...
  }, React__default.createElement(reactNative.Text, null, "X")));
};
    ...
    value: function render() {
      ...
      if (a.type === 'giphy' || type === 'card') {
        if (a.actions && a.actions.length) {
          return React__default.createElement(reactNative.View, null, React__default.createElement(Card, a), React__default.createElement(AttachmentActions, _extends({
      ...
      if (a.type === 'file') {
        ...
        }, a.title), React__default.createElement(reactNative.Text, null, a.file_size, " KB"))));
      }
...
function (_React$Component) {
  ...
  _createClass(CommandsItem, [{
    ...
    value: function render() {
      ...
      }, "/", name, " "), React__default.createElement(reactNative.Text, null, args)), React__default.createElement(reactNative.Text, null, description));
    }
  }]);
...
function (_React$PureComponent) {
  ...
  _createClass(ReactionList, [{
    ...
    value: function render() {
      ...
      }, this._renderReactions(latestReactions), React__default.createElement(reactNative.Text, {
        style: {
          color: 'white',
          paddingLeft: 5,
          paddingRight: 5
...
function (_React$PureComponent) {
  ...
  _createClass(ReactionPicker, [{
    ...
    value: function render() {
      ...
      }, reactionPickerVisible && React__default.createElement(reactNative.TouchableOpacity, {
        onPress: handleDismiss,
        style: {
          flex: 1,
...
var MessageReplies = function MessageReplies(_ref) {
  ...
  }, pos === 'left' ? React__default.createElement(reactNative.Image, {
    source: img$8
  }) : null, React__default.createElement(reactNative.Text, {
    style: {
      color: '#006CFF'
    }
  }, message.reply_count, " ", message.reply_count === 1 ? 'Reply' : 'Replies'), pos === 'right' ? React__default.createElement(reactNative.Image, {
    style: {
      transform: [{
        rotateY: '180deg'
      }]
...
function (_React$PureComponent) {
    ...
    _defineProperty(_assertThisInitialized(_this), "openReactionSelector", function () {
      ...
      _this.messageContainer.measureInWindow(function (x, y, width) {
        _this.setState({
          ...
          rpRight: pos === 'right' ? Math.round(reactNative.Dimensions.get('window').width) - (x + width) : null
        });
      });
    });
  ...
  _createClass(MessageContent, [{
    ...
    value: function render() {
      ...
      if (message.deleted_at) return React__default.createElement(reactNative.View, {
      ...
      return React__default.createElement(reactNative.TouchableOpacity, contentProps, message.status === 'failed' ? React__default.createElement(reactNative.Text, null, "Message failed - try again") : null, message.latest_reactions && message.latest_reactions.length > 0 && React__default.createElement(ReactionList, {
        ...
        openThread: this.openThread,
        pos: pos
      }), showTime ? React__default.createElement(reactNative.View, {
        style: styles$$1.metaContainer
      }, React__default.createElement(reactNative.Text, {
        style: _objectSpread({}, styles$$1.metaText, {
          textAlign: pos
        })
      }, Moment(message.created_at).format('h:mmA'))) : null, React__default.createElement(reactNativeActionsheet.ActionSheetCustom, {
        ref: function ref(o) {
          _this2.ActionSheet = o;
        },
        title: React__default.createElement(reactNative.Text, null, "Choose an action"),
...
function (_PureComponent) {
  ...
  _createClass(MessageList, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(React__default.Fragment, null, React__default.createElement(reactNative.FlatList, {
        ref: function ref(fl) {
...
function (_React$PureComponent) {
  ...
  _createClass(WithProgressIndicator, [{
    ...
    value: function render() {
      ...
      }, this.props.children, React__default.createElement(reactNative.View, {
        style: {
          position: 'absolute',
          height: '100%',
          width: '100%',
      ...
      }, this.props.type === ProgressIndicatorTypes.IN_PROGRESS && React__default.createElement(reactNative.ActivityIndicator, {
        color: "white"
      }), this.props.type === ProgressIndicatorTypes.RETRY && React__default.createElement(reactNative.Image, {
        source: img$b,
        style: {
          height: 25,
          width: 25
...
function (_PureComponent) {
  ...
  _createClass(MessageInput, [{
    ...
    value: function render() {
      ...
      }, this.props.editing ? React__default.createElement(reactNative.Image, {
        source: img$9
      }) : React__default.createElement(reactNative.Image, {
        source: img$a
      })))), React__default.createElement(reactNative.Text, {
  ...
  return MessageInput;
}(React.PureComponent), _defineProperty(_class$3, "propTypes", {
  ...
  _createClass(ChannelPreviewMessenger, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(reactNative.TouchableOpacity, {
        ...
        ellipsizeMode: "tail",
        numberOfLines: 1
      }, channel.data.name), React__default.createElement(reactNative.Text, {
        style: {
          color: '#767676',
          fontSize: 11,
          flex: 3,
      ...
      }, this.props.latestMessage.created_at)), React__default.createElement(reactNative.Text, {
        style: {
          color: this.props.unread > 0 ? 'black' : '#767676',
          fontSize: 13,
          fontWeight: this.props.unread > 0 ? 'bold' : 'normal'
        }
      }, !channel.state.messages[0] ? 'Nothing yet...' : truncate(this.props.latestMessage.text.replace(/\n/g, ' '), 14))));
    }
  }]);
...
function (_PureComponent) {
  ...
  return ChannelList;
}(React.PureComponent), _defineProperty(_class$5, "propTypes", {
  /** The Preview to use, defaults to ChannelPreviewMessenger */
  Preview: PropTypes.oneOfType([PropTypes.node, PropTypes.func]),
...
function (_React$PureComponent2) {
  ...
  _createClass(ThreadInner, [{
    ...
    value: function render() {
      ...
      }, this.props)), React__default.createElement(reactNative.View, {
        style: {
          padding: 20,
      ...
      }, React__default.createElement(reactNative.Text, null, "Start of a new thread")));
...
function (_React$Component) {
  ...
  _createClass(IconBadge, [{
    ...
    value: function render() {
      ...
      return React.createElement(reactNative.View, null, children, unread > 0 && React.createElement(reactNative.View, {
        style: styles$$1.icon
      }, React.createElement(reactNative.View, {
        style: styles$$1.iconInner
      }, showNumber && React.createElement(reactNative.Text, {
        style: styles$$1.text
      }, unread))));
    }
  }]);
